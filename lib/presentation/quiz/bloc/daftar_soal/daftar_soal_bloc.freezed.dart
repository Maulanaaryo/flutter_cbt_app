...
mixin _$DaftarSoalState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Soal> data, int index, bool isNext) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Soal> data, int index, bool isNext)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Soal> data, this.index, this.isNext)
      : _data = data;
  ...
  @override
  String toString() {
    return 'DaftarSoalState.loaded(data: $data, index: $index, isNext: $isNext)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(data, index, isNext);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(data, index, isNext);
  }
...
abstract class _Loaded implements DaftarSoalState {
  const factory _Loaded(
      final List<Soal> data, final int index, final bool isNext) = _$LoadedImpl;
